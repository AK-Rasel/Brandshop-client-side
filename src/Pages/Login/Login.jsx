                ...
                <div className=" flex-shrink-0 w-full max-w-xl shadow-2xl bg-base-100">
                    <form onSubmit={loginEven} className=" p-8">
                        <div className="form-control">
                            ...
                            <input type="email" name="email" placeholder="email" className="input focus:outline-none rounded-none border-[#F0C543] input-bordered" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Password</span>
                            </label>
                            <input name="password" type="password" placeholder="password" className="input rounded-none focus:outline-none input-bordered border-[#F0C543]" required />
                            {/* massagess */}
                            <label className="label">
                            {
