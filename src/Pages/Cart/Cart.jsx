...
const Cart = () => {
    ...
    const deleteHandle = (id) => {
        setCarts((items) => {
            ...
            // problem
            return data ? data : <div><h1>no Found</h1></div>
        });
    };
        ...
        <div>
            {
                carts.map(cart => (
                    ...
                    <div className="container mx-auto" key={cart.id}>
                        ...
                        <img className="h-full" src='https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?auto=format&fit=crop&q=80&w=1000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8fA%3D%3D' alt="Movie" />
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-end">
                                ...
                                <button onClick={() => deleteHandle(cart.id)} className="btn  rounded-none btn-ghost text-[#F0C543] font-semibold normal-case text-base">Delate</button>
